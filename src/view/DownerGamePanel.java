...
public class DownerGamePanel extends AbstractGamePanel	{ 
	...
	public DownerGamePanel(Point locationOnFrame, Point screenSize, String playerName, int balance) {
		super(locationOnFrame, screenSize, playerName);
	...
	public DownerGamePanel(Point locationOnFrame, Point screenSize, String playerName, int balance, Boolean debugPositioningMode) {
		super(locationOnFrame, screenSize, playerName, debugPositioningMode);
		this.balance = balance;
