...
public class HandTest {
	...
	*  ****/
	...
	/****************************************************************************
	* 
	* Method: void testGetCardsNames
	*  ****/
	
	@Test (timeout = DEFAULT_TIMEOUT)
    public void testGetCardsNames() {
		Hand actual_hand = new Hand();
		Suit suit = new Suit("Clubs");
		Card first_card = new Card(10,"Ten", suit);
		Card second_card = new Card(9,"Nine", suit);
		actual_hand.addCard(first_card);
		actual_hand.addCard(second_card);
		
		String[] actual_card_name = actual_hand.getCardsNames();
		       
        assertEquals("Method testGetCardsNames First card was unsuccessfull",first_card.getName(),actual_card_name[0]);
        assertEquals("Method testGetCardsNames Second card was unsuccessfull",second_card.getName(),actual_card_name[1]);
